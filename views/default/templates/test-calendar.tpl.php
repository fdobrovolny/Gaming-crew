<div id="main">
	...
	<p>
    <a href="calendar/?&amp;month={pm}&amp;year={py}">Předchozí</a>
    <a href="calendar/?&amp;month={nm}&amp;year={ny}">Další</a>
  </p> 
	
	<div>  
		<table id=""> 
					<tr> 
						<th class="" width="150px;">{cal_0_day_0}</th> 
						...
						<th class="weekend" width="150px;">{cal_0_day_5}</th> 
						<th class="weekend" width="150px;">{cal_0_day_6}</th> 
					</tr> 
					<tr> 
						<td class="{cal_0_dates_style_0}">{cal_0_dates_0} {cal_0_dates_data_0}</td> 
						...
						<td class="weekend {cal_0_dates_style_5}">{cal_0_dates_5} {cal_0_dates_data_5}</td> 
						<td class="weekend {cal_0_dates_style_6}">{cal_0_dates_6} {cal_0_dates_data_6}</td> 
					</tr> 
					<tr> 
						<td class="{cal_0_dates_style_7}">{cal_0_dates_7} {cal_0_dates_data_7}</td> 
						...
						<td class="weekend {cal_0_dates_style_12}">{cal_0_dates_12} {cal_0_dates_data_12}</td> 
						<td class="weekend {cal_0_dates_style_13}">{cal_0_dates_13} {cal_0_dates_data_13}</td> 
					</tr> 
					<tr> 
						<td class="{cal_0_dates_style_14}">{cal_0_dates_14} {cal_0_dates_data_14}</td> 
						...
						<td class="weekend {cal_0_dates_style_18}">{cal_0_dates_19} {cal_0_dates_data_19}</td> 
						<td class="weekend {cal_0_dates_style_20}">{cal_0_dates_20} {cal_0_dates_data_20}</td> 
					</tr> 
					<tr> 
						<td class="{cal_0_dates_style_21}">{cal_0_dates_21} {cal_0_dates_data_21}</td> 
						...
						<td class="weekend {cal_0_dates_style_26}">{cal_0_dates_26} {cal_0_dates_data_26}</td> 
						<td class="weekend {cal_0_dates_style_27}">{cal_0_dates_27} {cal_0_dates_data_27}</td> 
					</tr> 
					<tr> 
						<td class="{cal_0_dates_style_28}">{cal_0_dates_28} {cal_0_dates_data_28}</td> 
						...
						<td class="weekend {cal_0_dates_style_33}">{cal_0_dates_33} {cal_0_dates_data_33}</td> 
						<td class="weekend {cal_0_dates_style_34}">{cal_0_dates_34} {cal_0_dates_data_34}</td> 
					</tr> 
					<tr> 
						<td class="{cal_0_dates_style_35}">{cal_0_dates_35} {cal_0_dates_data_35}</td> 
						...
						<td class="weekend {cal_0_dates_style_40}">{cal_0_dates_40} {cal_0_dates_data_40}</td> 
